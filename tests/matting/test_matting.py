"""Feature-first: Tests for local matting and presentation preferences."""
...
def test_matanyone_runtime_finds_the_package_level_vendored_module() -> None:
    """Keep module discovery valid when the runtime lives inside the matting package."""
    module = ensure_vendored_matanyone()

    assert module.__name__ == "matanyone2"
