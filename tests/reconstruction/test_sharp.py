"""Feature-first: Upload-first SHARP build, validation, and managed-checkpoint tests."""
...
from better_backgrounds.jobs.events import CancelControl, ProgressEvent
...
if TYPE_CHECKING:
    ...
    from better_backgrounds.reconstruction.sharp.runtime import SharpDevice
...
def test_sharp_runtime_finds_the_package_level_vendored_module() -> None:
    """Keep SHARP discovery valid from the nested reconstruction package."""
    module = ensure_vendored_sharp()
