...
from better_backgrounds.live_matting import MattingCapabilities, MattingConfig
...
def _import_upstream() -> ModuleType:
...
class MatAnyoneRuntime:
    ...
    def __init__(self, checkpoint: Path, config: MattingConfig) -> None:
        ...
        config_dir = Path(__file__).resolve().parent / "_vendor" / "matanyone2" / "config"
